        ...
        <div class="bottom_container">
            ...
            <div class="secondColum">
                <div class="main" style="display:block;">
                    <div class="softwares">
                        <h2>Softrware Edit</h2>
                    </div>
                    <div class="modal-content">
                        <form action="{{ route('SoftwareUpdate', ['id'=>$software->id]) }}" method="POST">
                            @csrf
                            <h2>Edit Software</h2>
                            <hr>
                            <label>Software Name</label><br>
                            <input type="text" name="software_name" class="textField"
                                required value="{{ $software->software_name }}"> <br>
                            <br>
                            <label>Software Version </label><br>
                            <input type="text" name="current_version"
                                class="textField" required value="{{ $software->current_version }}"> <br>
                            <br>
