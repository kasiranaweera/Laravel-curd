            ...
            <div class="secondColum">
                <div class="main">
                    ...
                    <div class="button">
                        ...
                        <button onclick="openModal('modal1')" class="buttonn">Add Software +</button>

                        <div id="modal1" class="modal">
                            <div class="modal-content">
                                <form action="{{ route('SoftwareStore') }}" method="POST">
                                    @csrf
                                    <h2>Creat Software<i class='bx bx-x' onclick="closeModal('modal1')"></i></h2>
                                    <hr>
                                    <label>Software Name</label><br>
                                    <input type="text" placeholder="Enter Developer Name" name="software_name"
                                        class="textField" required> <br>
                                    <br>
                                    <label>Software Version </label><br>
                                    <input type="text" placeholder="Enter Developer Name" name="current_version"
                                        class="textField" required> <br>
                                    <br>
                ...
                <div class="row2">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('editSoftware', ['id'=>$item->id]) }}"><button>Edit</button></a>
                                <a href="{{ route('deleteSoftware', ['id'=>$item->id]) }}"><button>Delete</button></a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
